...
public class ExtentManager {
    ...
    public synchronized static ExtentReports getReporter(){
        if(extent == null){
            String reportPath= System.getProperty("user.dir")+"/testoutput/extentreport/ExtentReport_"+ LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMddHHmmss"))+".html";
            ExtentSparkReporter spark = new ExtentSparkReporter(reportPath);
            spark.config().setReportName("Thu-Automation Test Report");
            spark.config().setDocumentTitle("Thu-OrangeHRM Report");
    ...
    public static String takeScreenshot(WebDriver driver, String screenshotName){
        ...
        //getScreenshot used to capture the image from the browser and save it as OutputType
    ...
    //Attach screenshot to report using Báe64
